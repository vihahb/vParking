...
public class HomePresenter {
    ...
    public void activeParkingMaster() {
        HomeModel.getInstance().activeParkingMaster(new RequestListener() {
            @Override
            public void onSuccess(String result) {
                Log.e(homeView.getActivity().getClass().getSimpleName(), "null k: " + result);
            ...
            public void onError(String error) {
                homeView.onActiveMasterFailed(error);
            }
        });
    }
